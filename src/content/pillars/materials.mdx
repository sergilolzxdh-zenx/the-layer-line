...
See the full [PLA vs. PETG vs. ABS comparison](/materials/pla-vs-petg-vs-abs/) for a side-by-side on temperatures, bed adhesion, and typical uses, the [PETG guide](/materials/petg-guide/) for a deeper look at the material most people move to after PLA, the [ABS/ASA guide](/materials/abs-asa-guide/) for heat-resistant and outdoor parts, or the [TPU guide](/materials/tpu-guide/) if the part needs to flex rather than stay rigid.
